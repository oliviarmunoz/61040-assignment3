...
exports.testManualScheduling = testManualScheduling;
exports.testLLMScheduling = testLLMScheduling;
exports.testMixedScheduling = testMixedScheduling;
const dayplanner_1 = require("./dayplanner");
...
async function testManualScheduling() {
    console.log('\n🧪 TEST CASE 1: Manual Scheduling');
    console.log('==================================');
    const planner = new dayplanner_1.DayPlanner();
    // Add some activities
 ...
 */
async function testLLMScheduling() {
    console.log('\n🧪 TEST CASE 2: LLM-Assisted Scheduling');
    console.log('========================================');
    const planner = new dayplanner_1.DayPlanner();
 ...
 */
async function testMixedScheduling() {
    console.log('\n🧪 TEST CASE 3: Mixed Scheduling');
    console.log('=================================');
    const planner = new dayplanner_1.DayPlanner();
    const config = loadConfig();
...
//# sourceMappingURL=dayplanner-tests.js.map